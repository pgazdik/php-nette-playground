...
DB Server|**host:** `localhost`; **port:** `41003`
...
DB Server|db-server|3306 (default)
...
`docker-compose exec php-fpm chown -R www-data:www-data /application/demo/www`
      ...
      "configurations": [
          {
              ...
              "pathMappings": {
                  "/application/demo/www": "${workspaceRoot}/"
              },
          }
      ]
  }
